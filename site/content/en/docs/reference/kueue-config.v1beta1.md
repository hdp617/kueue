...
## `ClusterProfiles`     {#config-kueue-x-k8s-io-v1beta1-ClusterProfiles}
...
<td>
   <p>Enable indicates whether to enable ClusterProfiles feature.</p>
</td>
</tr>
<tr><td><code>credentialsProvider</code> <B>[Required]</B><br/>
<a href="#config-kueue-x-k8s-io-v1beta1-CredentialsProvider"><code>CredentialsProvider</code></a>
</td>
<td>
...
## `CredentialsProvider`     {#config-kueue-x-k8s-io-v1beta1-CredentialsProvider}
...
<a href="#config-kueue-x-k8s-io-v1beta1-Provider"><code>[]Provider</code></a>
</td>
<td>
...
<a href="#config-kueue-x-k8s-io-v1beta1-ClusterProfiles"><code>ClusterProfiles</code></a>
</td>
<td>
...
## `Provider`     {#config-kueue-x-k8s-io-v1beta1-Provider}
