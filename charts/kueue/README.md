...
| controllerManager.manager.image.repository | string | `"us-central1-docker.pkg.dev/huypham-gke-dev/kueue/kueue"` | ControllerManager's image repository |
| controllerManager.manager.image.tag | string | `"clusterprofile-poc"` | ControllerManager's image tag |
...
| kueueViz.backend.image.repository | string | `"us-central1-docker.pkg.dev/huypham-gke-dev/kueue/kueueviz-backend"` | KueueViz dashboard backend image repository |
| kueueViz.backend.image.tag | string | `"clusterprofile-poc"` | KueueViz dashboard backend image tag |
...
| kueueViz.frontend.image.repository | string | `"us-central1-docker.pkg.dev/huypham-gke-dev/kueue/kueueviz-frontend"` | KueueViz dashboard frontend image repository |
| kueueViz.frontend.image.tag | string | `"clusterprofile-poc"` | KueueViz dashboard frontend image tag |
